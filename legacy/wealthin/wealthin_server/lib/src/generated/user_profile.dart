...
class UserProfileUpdateTable extends _i1.UpdateTable<UserProfileTable> {
  ...
  _i1.ColumnValue<List<String>, List<String>> completedGoals(
    List<String>? value,
  ) => _i1.ColumnValue(
...
class UserProfileTable extends _i1.Table<int?> {
  UserProfileTable({super.tableRelation}) : super(tableName: 'user_profiles') {
    ...
    completedGoals = _i1.ColumnSerializable<List<String>>(
      'completedGoals',
      this,
    );
  }
  ...
  late final _i1.ColumnSerializable<List<String>> completedGoals;
