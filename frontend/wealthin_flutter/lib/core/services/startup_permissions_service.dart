...
class StartupPermissionsService {
  ...
  Future<void> requestStartupPermissions(BuildContext context) async {
    ...
    if (!smsStatus.isGranted) {
      permissionsNeeded.add(Permission.sms);
    }
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              if (permissions.contains(Permission.sms)) ...[
                _buildPermissionItem(
                  icon: Icons.sms,
                  title: 'SMS Access',
                  description: 'Automatically track bank transactions from SMS messages. Save hours of manual entry!',
                  color: Colors.green,
                ),
