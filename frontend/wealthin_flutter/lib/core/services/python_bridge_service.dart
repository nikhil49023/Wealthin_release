...
class PythonBridgeService {
  ...
  Future<Map<String, dynamic>> generateAiAnalysis({
    ...
    try {
      ...
      return await _callPython('generate_ai_analysis', {
        'financial_data_json': dataJson,
      });
    } catch (e) {
      debugPrint('[PythonBridge] AI Analysis error: $e');
      return {'success': false, 'error': e.toString(), 'analysis': ''};
    }
  }
}
